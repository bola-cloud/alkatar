(function ($) {
  ...
  --------------------------------------------- */
    ...
    /*-------------------------------------------
    category-box-slide active
--------------------------------------------- */

    $(".direction-ltr .category-box-slide").slick({
        infinite: true,
        speed: 500,
        slidesToShow: 4,
        slidesToScroll: 1,
    ...
    $(".direction-rtl .category-box-slide").slick({
        infinite: true,
        speed: 500,
        slidesToShow: 4,
        slidesToScroll: 1,
    ...
    /*-------------------------------------------
    offers-box-slide active
    --------------------------------------------- */
    $(".direction-ltr .offers-box-slide").slick({
        infinite: true,
        speed: 500,
        slidesToShow: 4,
        slidesToScroll: 1,
    ...
    $(".direction-rtl .offers-box-slide").slick({
        infinite: true,
        speed: 500,
        slidesToShow: 4,
        slidesToScroll: 1,
    ...
    if (
        $(
            ".featured-productss-area, .featured-products-area-v2, .product-list, .product-single-right"
        ).length
    ) {
