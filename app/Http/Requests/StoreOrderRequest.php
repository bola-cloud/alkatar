...
class StoreOrderRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'Collection_Method' => 'nullable|string|in:Delivery,STORE_PICKUP,delivery,store_pickup',
            'billing_state' => 'required_unless:Collection_Method,STORE_PICKUP,store_pickup|nullable|exists:states,id',
            'billing_city' => 'required_unless:Collection_Method,STORE_PICKUP,store_pickup|nullable|exists:cities,id',
            'billing_area_id' => 'required_unless:Collection_Method,STORE_PICKUP,store_pickup|nullable|exists:areas,id',
