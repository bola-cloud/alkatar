                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-vertical__item bg-style">
                                        ...
                                        <div class="input__group mb-25">
                                            <label for="slider_link">{{ __('Slider Link') }}</label>
                                            <input type="text" id="slider_link" name="slider_link"
                                                value="{{ $edit->slider_link }}" placeholder="{{ __('Slider Link') }}">
                                        </div>
                                        {{-- <div class="input__group mb-25">
                                        ...
                                        {{-- <div class="input__group mb-25">
                                            ...
                                            <textarea id="en_description" name="en_description"
                                                placeholder="{{ __('Description') }}">{{ $edit->en_Description }}</textarea>
                                        </div> --}}
                                        {{-- <div class="input__group mb-25">
                                            <label for="thumbnail">{{ __('Thumbnail') }}(545x656) </label>
                                            <input type="file" class="putImage1" name="thumbnail" id="thumbnail">
                                            <img class="admin_image" src="{{ asset(SliderImage() . $edit->Thumbnail) }}"
                                                id="target1" />
                                        </div> --}}
                                        <div class="input__group mb-25">
                                            <label for="background_image">{{ __('BackGround Image') }}
                                                (1920x620)</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-vertical__item bg-style">
                                        ...
                                        <div class="input__group mb-25">
                                            ...
                                            <textarea id="fr_description" name="fr_description"
