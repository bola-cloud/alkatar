                                    ...
                                    <div class="form-vertical__item bg-style">
                                        ...
                                        <div class="input__group mb-25">
                                            ...
                                            <input type="text" class="form-control" id="slider_link" name="slider_link"
                                                value="{{ old('slider_link') }}" placeholder="{{ __('Slider Link') }}">
                                        </div>
                                        {{-- <div class="input__group mb-25">
                                        ...
                                        {{-- <div class="input__group mb-25">
                                            ...
                                            <input type="text" class="form-control" id="en_btn_text" name="en_btn_text"
                                                value="{{ old('en_btn_text') }}" placeholder="{{ __('Button Text') }}">
                                        </div> --}}
                                        {{-- <div class="input__group mb-25">
                                            <label for="en_description">{{ __('Description') }}</label>
                                            <textarea id="en_description" name="en_description" class="form-control"
                                    ...
                                    <div class="form-vertical__item bg-style">
                                        ...
                                        <div class="input__group mb-25">
                                            ...
                                            <input type="text" class="form-control" id="fr_btn_text" name="fr_btn_text"
                                                value="{{ old('fr_btn_text') }}" placeholder="{{ __('Button Text') }}">
                                        </div>
                                        <div class="input__group mb-25">
                                            <label for="fr_description">{{ __('Description') }}</label>
                                            <textarea id="fr_description" name="fr_description" class="form-control"
                                                placeholder="{{ __('Description') }}">{{ old('fr_description') }}</textarea>
                                        </div> --}}
