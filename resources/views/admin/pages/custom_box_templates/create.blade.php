            ...
            <div class="breadcrumb__content">
                <div class="breadcrumb__content__left">
                    <div class="breadcrumb__title">
                        <h2>{{ __('Add Custom Box Template') }}</h2>
                    </div>
                </div>
                ...
                <div class="gallery__content">
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-one" role="tabpanel" aria-labelledby="nav-one-tab">
                            <form method="POST" action="{{ route('admin.custom_box_templates.store') }}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <input type="text" id="name_en" name="name_en" required value="{{ old('name_en') }}" placeholder="{{ __('Name') }}">
                                            </div>
                                            <div class="input__group mb-25">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <input type="text" id="color_code" name="color_code" required value="{{ old('color_code', '#1A4231') }}" placeholder="#1A4231">
                                            </div>
                                            <div class="input__group mb-25">
                                                <label for="price">{{ __('Base Packaging Price (OMR)') }}</label>
                                                <input type="number" step="0.001" min="0" id="price" name="price" required value="{{ old('price', '2.000') }}" placeholder="2.000">
                                            </div>
                                            <div class="input__group mb-25">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <input type="text" id="name_ar" name="name_ar" required value="{{ old('name_ar') }}" placeholder="{{ __('Name') }}">
                                            </div>
                                            <div class="input__group mb-25">
