            ...
            <div class="customers__table">
                <table id="BlogTable" class="dataTableHover row-border data-table-filter table-style">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $pg->name }}</td>
                            <td><img src="{{ asset(IMG_PAYMENT_GATEWAY . $pg->image) }}" alt="{{ $pg->name }}"
                                    style=" height: 70px;">
                            </td>
                            <td>
        ...
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" method="POST"
                ...
                <div class="modal-body">
                    ...
                    <div class="input__group mb-25">
                        <label for="exampleInputEmail1">{{ __('Secret') }}</label>
                        <input type="text" name="sslcz_store_password" value="{{ env('SSLCZ_STORE_PASSWORD') }}">
                    </div>
                    @endif
                    @if ($pg->slug == 'razorpay')
                    <div class="input__group mb-25">
                    ...
                    <div class="input__group mb-25">
                        ...
                        <div class="custom-control custom-switch">
                            <input type="checkbox" name="status" class="custom-control-input" id="customSwitch1"
                                value="1" {{ $pg->status == ACTIVE ? 'checked' : '' }}>
                            <label class="custom-control-label" for="customSwitch1">{{ __('Click here to check/uncheck
                                visibility.') }}</label>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" method="POST"
                ...
                <div class="modal-body">
                    ...
                    <div class="input__group mb-25">
                        <label for="question">{{ __('Name') }}</label>
                        <input type="text" name="name" placeholder="{{ __('Name') }}" value="{{ env('COD_NAME') }}">
                    </div>
                    <div class="input__group mb-25">
                        <label for="exampleInputEmail1">{{ __('Thumbnail') }}</label>
                        <input type="file" class="putImage1" name="image" id="image">
