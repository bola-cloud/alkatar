@extends('admin.master', ['menu' => 'crm', 'submenu' => 'expert_requests'])
                ...
                <div class="breadcrumb__content__right">
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('Expert Requests') }}</li>
                        </ul>
                    </nav>
                </div>
            </div>
                    ...
                    <table class="dataTableHover row-border table-style table table-striped table-bordered text-center">
                        ...
                        @forelse ($requests as $req)
                            <tr>
                                ...
                                <td>{{ $req->phone }}</td>
                                <td>
                                    <form action="{{ route('admin.expert-requests.update_status', $req->id) }}" method="POST" class="d-inline-block">
                                        @csrf
                                ...
                                <td>
                                    <div class="action__buttons">
                                        ...
                                        <a href="{{ route('admin.expert-requests.delete', $req->id) }}" class="btn-action delete text-danger" onclick="return confirm('{{ __('Are you sure you want to delete this request?') }}')"><i class="fas fa-trash-alt"></i></a>
                                    </div>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="7" class="text-center">{{ __('No Expert Requests Found!') }}</td>
                            </tr>
                        @endforelse
                        </tbody>
                    </table>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-success">
                        <h5 class="modal-title text-white" id="viewModalLongTitle">{{ __('Expert Request Details') }}</h5>
                    ...
                    <div class="modal-body text-start">
                        ...
                        <div class="mb-3">
                            <h6 class="fw-bold mb-1">{{ __('Message') }}:</h6>
