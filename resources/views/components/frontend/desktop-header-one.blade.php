                ...
                <div class="search-area">
                    <form action="{{ route('category.product') }}" method="get">
                        <div class="search-wrap">
                            <input type="text"
                                class="form-control !border-none !outline-none !ring-0 placeholder:text-2xl placeholder:ps-5 text-2xl ps-5"
                                id="search" name="search" placeholder="{{ __('Search Here') }}" />
                            <button type="submit" class="search-btn"><i
                                    class="flaticon-search mt-2 inline-block"></i></button>
                        </div>
                    </form>
                    <div id="search-suggestions" class="absolute bg-white shadow-md  search-area !m-0  z-10"></div>
                </div>
