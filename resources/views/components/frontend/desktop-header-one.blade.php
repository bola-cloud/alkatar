...
<div>
    <header class="header-area d-none d-lg-block">
                ...
                <div class="search-area">
                    <form action="{{ route('category.product') }}" method="get">
                        <div class="search-wrap">
                            <input type="text" class="form-control !border-none !outline-none !ring-0" id="search"
                                name="search" placeholder="{{ __('Search Here') }}" />
        ...
        <div class="bg-white py-4 !px-12 border-t">
            <div>
                <nav class="menu-area">
