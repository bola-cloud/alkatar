                                ...
                                <tr>
                                    <td>
                                        <div class="product-image">
                                            ...
                                            <div class="product-flags">
                                                ...
                                                <span class="product-flag sale">{{ $wishlist->product->ItemTag }}</span>
                                                @endif
                                                @if ($wishlist->product->Discount > 0)
                                                <span class="product-flag discount">{{ __('-') }}{{
                                                    $wishlist->product->Discount }}</span>
                                                @endif
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="product-info text-center">
                                            <h3 class="product-name"><a class="product-link"
                                                    href="{{ route('single.product', $wishlist->product->en_Product_Slug) }}">{{
                                                    $wishlist->product->en_Product_Name }}</a>
                                            </h3>
                                    ...
                                    <td>
                                        <div class="product-price text-center">
                                            @if ($wishlist->product->Discount > 0)
                                            <span class="regular-price">{{ currencyConverter($wishlist->product->Price)
                                                }}</span>
                                            @endif
                                            <span class="price">{{ currencyConverter($wishlist->product->Discount_Price)
                                                }}</span>
                                        </div>
                                    </td>
                                    <td>
