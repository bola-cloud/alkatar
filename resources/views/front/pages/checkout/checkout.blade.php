                            ...
                            <div class="space-y-4">
                                @if (auth()->user() && auth()->user()->is_admin == 1)
                                    ...
                                    <select id="user_id" name="user_id"
                                        class="form-control select2 w-11/12 lg:w-full p-3 lg:p-4 border rounded h-14 lg:h-16 text-lg lg:text-xl">
                                ...
                                @if (auth()->user() && auth()->user()->is_admin == 1)
                                    ...
                                    <div class="space-y-4" id="phoneDiv" style="display: none;">
                                        <input type="tel" id="phone_number_user" name="phone_number"
                                    ...
                                    <div class="space-y-4" id="phoneDiv2">
                            ...
                            <div class="mt-8">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex gap-3 space-x-2 mt-4">
                                        <input type="checkbox" class="form-check-input !accent-primary-red"
                                            id="agree" required />
                ...
                <div class="cart-summary bg-white !p-8 rounded-lg shadow-md lg:h-full">
                    ...
                    <ul class="space-y-4">
                        ...
                        @foreach ($content as $item)
                            <li
                                class="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b pb-4">
                                <div class="flex items-center space-x-4 mb-2 sm:mb-0">
                                    <img src="{{ asset(ProductImage() . $item->options->image) }}"
                                        alt="{{ $item->name }}" class="w-20 h-20 lg:w-32 lg:h-32 object-cover rounded">
                                    <div class="!ms-10">
                                        ...
                                        @endif
                                        <p class="text-2xl lg:text-3xl text-gray-600">{{ __('Quantity') }}:
                                            {{ $item->qty }}</p>
                                    </div>
                                </div>
                    ...
                    <div class="mt-6">
                        ...
                        <form action="{{ route('apply.coupon') }}" method="post" class="flex"
                            style="
    ...
    @push('post_script')
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                const phoneNormalInput = document.getElementById("phone_number");
                ...
                if (userSelect) {
                    userSelect.addEventListener("change", function() {
                        ...
                        if (selectedOption.value) {
                            ...
                            phoneDiv2.style.display = "block";
                            phoneDiv.style.display = "none";
                            phoneNormalInput.value = "";
                            phoneInput.value = "00";
