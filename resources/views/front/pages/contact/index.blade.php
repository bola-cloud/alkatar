...
@section('content')
    ...
    <div class="contact-us-area relative">
        <div class="container contact-us-container">
            <div class="grid grid-cols-[1fr_2fr] items-center gap-5 px-10 w-10/12 mx-auto">
                <div class="contact-us-top">
                    <div class="flex flex-col justify-between h-full">
                        <div class="col-lg-4 col-md-4 col-sm-6 contact_us_card">
