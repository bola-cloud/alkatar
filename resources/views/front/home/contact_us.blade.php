    ...
    <div class="container mx-auto px-4 lg:px-8 pb-24 max-w-6xl flex flex-col gap-12">
                    ...
                    <div class="flex flex-col gap-3 mt-4 text-start">
                        ...
                        <div class="flex items-center gap-3">
                            @if($socialLinks->Facebook)
                                <a href="{{ $socialLinks->Facebook }}" target="_blank" class="w-10 h-10 rounded-full border border-gray-200 hover:bg-gray-50 flex items-center justify-center text-[#1A4231] transition-all">
                            ...
                            @if($socialLinks->Twitter)
                                <a href="{{ $socialLinks->Twitter }}" target="_blank" class="w-10 h-10 rounded-full border border-gray-200 hover:bg-gray-50 flex items-center justify-center text-[#1A4231] transition-all">
                            ...
                            @if($socialLinks->Instagram)
                                <a href="{{ $socialLinks->Instagram }}" target="_blank" class="w-10 h-10 rounded-full border border-gray-200 hover:bg-gray-50 flex items-center justify-center text-[#1A4231] transition-all">
                                    <svg class="w-4.5 h-4.5 fill-current" viewBox="0 0 24 24">
                            ...
                            @if($socialLinks->Linkedin)
                                <a href="{{ $socialLinks->Linkedin }}" target="_blank" class="w-10 h-10 rounded-full border border-gray-200 hover:bg-gray-50 flex items-center justify-center text-[#1A4231] transition-all">
                                    <svg class="w-4.5 h-4.5 fill-current" viewBox="0 0 24 24">
        ...
        <section class="w-full">
            <div class="rounded-3xl overflow-hidden border border-gray-200 shadow-sm h-[320px]">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d115918.42398539268!2d46.72186835!3d24.81381395!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e2f03890d489399%3A0xba974d1c98e91f55!2sRiyadh%20Saudi%20Arabia!5e0!3m2!1sen!2ssa!4v1680000000000!5m2!1sen!2ssa" 
